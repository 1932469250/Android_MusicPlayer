...
public class Player extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //将得到的封面byte数组decode为封面Bitmap
//        byte[] songFront_byte = bundle.getByteArray("song_front_byte");
//        //布局文件中将此处的ImageView背景设置为默认封面，故未获取到封面时不需要在此设置
//        if (songFront_byte != null){
//            Bitmap song_front = BitmapFactory.decodeByteArray(songFront_byte, 0, songFront_byte.length);
//            front_iv.setImageBitmap(song_front);
//        }
